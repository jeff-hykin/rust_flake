{
    ...
    inputs = {
        ...
        rust-manifest = {
            url = "https://static.rust-lang.org/dist/2024-09-05/channel-rust-1.81.0.toml";
            flake = false;
        };
    };
                    ...
                    lib = {
                        rustPlatform = rustPlatform // {
                            info = {
                                version = "1.81.0";
                                channel = "stable";
                                manifestUrl = "https://static.rust-lang.org/dist/2024-09-05/channel-rust-1.81.0.toml";
                                date = "2024-09-05"; 
                            };
                        };
                    };

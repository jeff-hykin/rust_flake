{
    ...
    inputs = {
        ...
        rust-manifest = {
            url = "https://static.rust-lang.org/dist/2024-06-13/channel-rust-1.79.0.toml";
            flake = false;
        };
    };
                    ...
                    lib = {
                        rustPlatform = rustPlatform // {
                            info = {
                                version = "1.79.0";
                                channel = "stable";
                                manifestUrl = "https://static.rust-lang.org/dist/2024-06-13/channel-rust-1.79.0.toml";
                                date = "2024-06-13"; 
                            };
                        };
                    };

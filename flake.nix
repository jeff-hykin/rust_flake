{
    ...
    inputs = {
        ...
        rust-manifest = {
            url = "https://static.rust-lang.org/dist/2025-01-30/channel-rust-1.84.1.toml";
            flake = false;
        };
    };
                    ...
                    lib = {
                        rustPlatform = rustPlatform // {
                            info = {
                                version = "1.84.1";
                                channel = "stable";
                                manifestUrl = "https://static.rust-lang.org/dist/2025-01-30/channel-rust-1.84.1.toml";
                                date = "2025-01-30"; 
                            };
                        };
                    };

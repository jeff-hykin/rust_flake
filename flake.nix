{
    ...
    inputs = {
        ...
        rust-manifest = {
            url = "https://static.rust-lang.org/dist/2022-12-15/channel-rust-1.66.0.toml";
            flake = false;
        };
    };
                    ...
                    lib = {
                        rustPlatform = rustPlatform // {
                            info = {
                                version = "1.66.0";
                                channel = "stable";
                                manifestUrl = "https://static.rust-lang.org/dist/2022-12-15/channel-rust-1.66.0.toml";
                                date = "2022-12-15"; 
                            };
                        };
                    };

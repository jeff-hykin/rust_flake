{
    ...
    inputs = {
        ...
        rust-manifest = {
            url = "https://static.rust-lang.org/dist/2022-01-20/channel-rust-1.58.1.toml";
            flake = false;
        };
    };
                    ...
                    lib = {
                        rustPlatform = rustPlatform // {
                            info = {
                                version = "1.58.1";
                                channel = "stable";
                                manifestUrl = "https://static.rust-lang.org/dist/2022-01-20/channel-rust-1.58.1.toml";
                                date = "2022-01-20"; 
                            };
                        };
                    };

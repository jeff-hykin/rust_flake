{
    ...
    inputs = {
        ...
        rust-manifest = {
            url = "https://static.rust-lang.org/dist/2022-04-07/channel-rust-1.60.0.toml";
            flake = false;
        };
    };
                    ...
                    lib = {
                        rustPlatform = rustPlatform // {
                            info = {
                                version = "1.60.0";
                                channel = "stable";
                                manifestUrl = "https://static.rust-lang.org/dist/2022-04-07/channel-rust-1.60.0.toml";
                                date = "2022-04-07"; 
                            };
                        };
                    };

{
    ...
    inputs = {
        ...
        rust-manifest = {
            url = "https://static.rust-lang.org/dist/2024-08-08/channel-rust-1.80.1.toml";
            flake = false;
        };
    };
                    ...
                    lib = {
                        rustPlatform = rustPlatform // {
                            info = {
                                version = "1.80.1";
                                channel = "stable";
                                manifestUrl = "https://static.rust-lang.org/dist/2024-08-08/channel-rust-1.80.1.toml";
                                date = "2024-08-08"; 
                            };
                        };
                    };

{
    ...
    inputs = {
        ...
        rust-manifest = {
            url = "https://static.rust-lang.org/dist/2023-01-10/channel-rust-1.66.1.toml";
            flake = false;
        };
    };
                    ...
                    lib = {
                        rustPlatform = rustPlatform // {
                            info = {
                                version = "1.66.1";
                                channel = "stable";
                                manifestUrl = "https://static.rust-lang.org/dist/2023-01-10/channel-rust-1.66.1.toml";
                                date = "2023-01-10"; 
                            };
                        };
                    };

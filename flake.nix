{
    ...
    inputs = {
        ...
        rust-manifest = {
            url = "https://static.rust-lang.org/dist/2025-08-07/channel-rust-1.89.0.toml";
            flake = false;
        };
    };
                    ...
                    lib = {
                        rustPlatform = rustPlatform // {
                            info = {
                                version = "1.89.0";
                                channel = "stable";
                                manifestUrl = "https://static.rust-lang.org/dist/2025-08-07/channel-rust-1.89.0.toml";
                                date = "2025-08-07"; 
                            };
                        };
                    };

{
    ...
    inputs = {
        ...
        rust-manifest = {
            url = "https://static.rust-lang.org/dist/2021-12-02/channel-rust-1.57.0.toml";
            flake = false;
        };
    };
                    ...
                    lib = {
                        rustPlatform = rustPlatform // {
                            info = {
                                version = "1.57.0";
                                channel = "stable";
                                manifestUrl = "https://static.rust-lang.org/dist/2021-12-02/channel-rust-1.57.0.toml";
                                date = "2021-12-02"; 
                            };
                        };
                    };

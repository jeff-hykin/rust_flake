{
    ...
    inputs = {
        ...
        rust-manifest = {
            url = "https://static.rust-lang.org/dist/2021-05-10/channel-rust-1.52.1.toml";
            flake = false;
        };
    };
                    ...
                    lib = {
                        rustPlatform = rustPlatform // {
                            info = {
                                version = "1.52.1";
                                channel = "stable";
                                manifestUrl = "https://static.rust-lang.org/dist/2021-05-10/channel-rust-1.52.1.toml";
                                date = "2021-05-10"; 
                            };
                        };
                    };

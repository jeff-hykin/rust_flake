{
    ...
    inputs = {
        ...
        rust-manifest = {
            url = "https://static.rust-lang.org/dist/2024-03-28/channel-rust-1.77.1.toml";
            flake = false;
        };
    };
                    ...
                    lib = {
                        rustPlatform = rustPlatform // {
                            info = {
                                version = "1.77.1";
                                channel = "stable";
                                manifestUrl = "https://static.rust-lang.org/dist/2024-03-28/channel-rust-1.77.1.toml";
                                date = "2024-03-28"; 
                            };
                        };
                    };

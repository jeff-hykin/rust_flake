{
    ...
    inputs = {
        ...
        rust-manifest = {
            url = "https://static.rust-lang.org/dist/2024-07-25/channel-rust-1.80.0.toml";
            flake = false;
        };
    };
                    ...
                    lib = {
                        rustPlatform = rustPlatform // {
                            info = {
                                version = "1.80.0";
                                channel = "stable";
                                manifestUrl = "https://static.rust-lang.org/dist/2024-07-25/channel-rust-1.80.0.toml";
                                date = "2024-07-25"; 
                            };
                        };
                    };

{
    ...
    inputs = {
        ...
        rust-manifest = {
            url = "https://static.rust-lang.org/dist/2022-11-03/channel-rust-1.65.0.toml";
            flake = false;
        };
    };
                    ...
                    lib = {
                        rustPlatform = rustPlatform // {
                            info = {
                                version = "1.65.0";
                                channel = "stable";
                                manifestUrl = "https://static.rust-lang.org/dist/2022-11-03/channel-rust-1.65.0.toml";
                                date = "2022-11-03"; 
                            };
                        };
                    };

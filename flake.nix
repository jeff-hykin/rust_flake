{
    ...
    inputs = {
        ...
        rust-manifest = {
            url = "https://static.rust-lang.org/dist/2024-11-28/channel-rust-1.83.0.toml";
            flake = false;
        };
    };
                    ...
                    lib = {
                        rustPlatform = rustPlatform // {
                            info = {
                                version = "1.83.0";
                                channel = "stable";
                                manifestUrl = "https://static.rust-lang.org/dist/2024-11-28/channel-rust-1.83.0.toml";
                                date = "2024-11-28"; 
                            };
                        };
                    };

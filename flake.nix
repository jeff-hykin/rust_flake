{
    ...
    inputs = {
        ...
        rust-manifest = {
            url = "https://static.rust-lang.org/dist/2025-01-09/channel-rust-1.84.0.toml";
            flake = false;
        };
    };
                    ...
                    lib = {
                        rustPlatform = rustPlatform // {
                            info = {
                                version = "1.84.0";
                                channel = "stable";
                                manifestUrl = "https://static.rust-lang.org/dist/2025-01-09/channel-rust-1.84.0.toml";
                                date = "2025-01-09"; 
                            };
                        };
                    };

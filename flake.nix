{
    ...
    inputs = {
        ...
        rust-manifest = {
            url = "https://static.rust-lang.org/dist/2023-12-28/channel-rust-1.75.0.toml";
            flake = false;
        };
    };
                    ...
                    lib = {
                        rustPlatform = rustPlatform // {
                            info = {
                                version = "1.75.0";
                                channel = "stable";
                                manifestUrl = "https://static.rust-lang.org/dist/2023-12-28/channel-rust-1.75.0.toml";
                                date = "2023-12-28"; 
                            };
                        };
                    };

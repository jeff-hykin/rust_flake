{
    ...
    inputs = {
        ...
        rust-manifest = {
            url = "https://static.rust-lang.org/dist/2021-09-09/channel-rust-1.55.0.toml";
            flake = false;
        };
    };
                    ...
                    lib = {
                        rustPlatform = rustPlatform // {
                            info = {
                                version = "1.55.0";
                                channel = "stable";
                                manifestUrl = "https://static.rust-lang.org/dist/2021-09-09/channel-rust-1.55.0.toml";
                                date = "2021-09-09"; 
                            };
                        };
                    };

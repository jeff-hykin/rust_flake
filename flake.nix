{
    ...
    inputs = {
        ...
        rust-manifest = {
            url = "https://static.rust-lang.org/dist/2022-01-13/channel-rust-1.58.0.toml";
            flake = false;
        };
    };
                    ...
                    lib = {
                        rustPlatform = rustPlatform // {
                            info = {
                                version = "1.58.0";
                                channel = "stable";
                                manifestUrl = "https://static.rust-lang.org/dist/2022-01-13/channel-rust-1.58.0.toml";
                                date = "2022-01-13"; 
                            };
                        };
                    };
